    ...
    ElectionsPrincipal
{
    ...
    /**
     * Stores custom name of the token, if being overridden
     */
    ...
    /**
     * Overrides the name of the token. May be called by anyone until
     * a maintainer is elected, then only maintainer may override it.
     */
